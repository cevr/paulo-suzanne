    ...
    <section className="relative overflow-hidden bg-secondary py-20 md:py-32">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-block bg-white p-4 mb-6 rotate-[-2deg] neo-brutalist">
          ...
          <p className="text-xl md:text-2xl font-bold mb-8 bg-white p-4 inline-block neo-brutalist rotate-[1deg]">
            {t(
