      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-block bg-primary p-4 mb-6 -rotate-2 neo-brutalist-yellow">
            ...
            <div className="relative">
              <div className="aspect-square bg-white p-4 neo-brutalist-red rotate-2">
              ...
              <div className="absolute -bottom-8 -right-8 bg-secondary p-4 neo-brutalist -rotate-3">
                <p className="text-2xl font-space-grotesk font-black">
