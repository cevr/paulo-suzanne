...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="py-20 bg-secondary scroll-mt-24 relative">
      <div className="retro-pattern absolute inset-0"></div>
      <div className="container mx-auto px-4 relative">
        <div className="text-center mb-12">
          <h2 className="inline-block text-4xl md:text-5xl font-space-grotesk font-black mb-4 bg-white p-4 neo-brutalist-red -rotate-1">
